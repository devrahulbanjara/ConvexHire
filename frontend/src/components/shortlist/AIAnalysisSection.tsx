...
export function AIAnalysisSection({ analysis, appliedAt, className }: AIAnalysisSectionProps) {
  ...
  return (
    <div className={className}>
      ...
      >
        <div className="bg-ai-50 dark:bg-ai-900/20 rounded-lg p-5 border border-ai-200 dark:border-ai-800 border-l-[3px] border-l-ai-500 space-y-4">
          {/* Tags */}
          ...
          {appliedAt && (
            <div className="pt-3 border-t border-ai-200/50 dark:border-ai-800/50">
              <span className="bg-ai-100/80 dark:bg-ai-950/50 text-ai-700 dark:text-ai-300 px-2.5 py-1 rounded-full text-xs font-medium inline-flex items-center gap-1.5">
