...
function ReferenceJDTableRow({
    ...
    return (
        ...
        >
            ...
            {/* Summary */}
            <td className="py-5 px-6">
                <p className="text-[13px] text-text-secondary line-clamp-2 leading-relaxed opacity-90" title={summary}>
                    {summary}
                </p>
            </td>
            ...
            <td className="py-5 px-6">
                <div className="flex items-center justify-end gap-3">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-56 p-2 shadow-2xl border-border-default rounded-xl">
                            <DropdownMenuItem
                                onClick={e => {
                                    e.stopPropagation()
                                    onJDClick(jd)
