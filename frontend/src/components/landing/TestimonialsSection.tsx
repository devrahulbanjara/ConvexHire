...
const testimonials = [
  {
    content:
      'Filtering through 500+ applications for a single Trainee role used to take my whole team a week. Now, the AI shortlist is ready before I even finish my morning chiya.',
  ...
  {
    content:
      "In Nepal, everyone lists 'React' on their CV regardless of skill. This tool actually flagged a candidate who understood deep architecture while filtering out the keyword-stuffers.",
    author: 'Binod Tamang',
  ...
  {
    content:
      'We were tired of tracking candidates across Viber groups and messy Excel sheets. Finally, a hiring tool that feels like it belongs in 2026, not a government office from the 90s.',
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-medium text-text-primary leading-tight mb-6">
            ...
            <span className="text-text-secondary">
              Mostly because we gave them their weekends back.
            </span>
          </h2>
        </motion.div>
