...
export function ManifestoSection() {
  return (
    <section className="py-16 lg:py-24 px-6 lg:px-8 bg-background relative overflow-hidden">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-6 text-lg sm:text-xl text-text-secondary font-sans leading-relaxed max-w-2xl">
            <p>
              Hiring shouldn't be a keyword matching game. It shouldn't be about who can cheat the
              system with hidden white text or perfectly formatted PDFs.
            </p>
            <p>
              It should be about reading between the lines. Understanding potential. Seeing the
              person behind the paper.
            </p>
