...
import { ArrowRight, Brain, ThumbsUp, ThumbsDown, FileText, Calendar, Database } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="relative bg-background-surface rounded-2xl shadow-xl border border-border-default overflow-hidden">
                ...
                <div className="p-6">
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-xl bg-success-50/50 dark:bg-success-950/20 border border-success-100 dark:border-success-900/30">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-xs font-bold text-success bg-success-100 dark:bg-success-900/50 px-2 py-1 rounded-full">
                            98% Match
                          </span>
                        </div>
                        <p className="text-xs text-text-secondary line-clamp-2 leading-relaxed">
                          Strong React & TypeScript experience. Previously led a team of 5 at a
                          fintech startup.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-xl bg-background-subtle border border-border-subtle opacity-75">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-xs font-medium text-text-tertiary bg-text-tertiary/10 px-2 py-1 rounded-full">
                            15% Match
                          </span>
                        </div>
                        <p className="text-xs text-text-tertiary line-clamp-1 leading-relaxed">
                          Missing required technical skills. Background primarily in content
                          creation.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 pt-4">
                      <div className="flex-1 p-3 rounded-lg bg-primary-50 dark:bg-primary-900/20 border border-primary-100 dark:border-primary-800/30 text-center">
                      ...
                      <div className="flex-1 p-3 rounded-lg bg-purple-50 dark:bg-purple-900/20 border border-purple-100 dark:border-purple-800/30 text-center">
          ...
          >
            ...
            <p className="text-lg text-text-secondary mb-8 max-w-md leading-relaxed font-sans">
              Your current ATS rejected qualified engineers because they wrote "Node" instead of
              "Node.js". Ours reads resumes like you would.
            </p>
