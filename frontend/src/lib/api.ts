  ...
  resumes: {
    ...
    experiences: {
      ...
      create: (resumeId: string) =>
        `/api/v1/resumes/${resumeId}/experiences/create`,
    ...
    education: {
      ...
      create: (resumeId: string) =>
        `/api/v1/resumes/${resumeId}/education/create`,
    ...
    certifications: {
      ...
      create: (resumeId: string) =>
        `/api/v1/resumes/${resumeId}/certifications/create`,
...
export const api = {
  ...
  auth: {
    ...
    selectRole: (role: string) =>
      apiClient.post(endpoints.auth.selectRole, { role }),
  ...
  users: {
    ...
    update: (id: string, data: unknown) =>
      apiClient.put(endpoints.users.update(id), data),
  ...
  jobs: {
    ...
    generateDraft: (data: unknown) =>
      apiClient.post(endpoints.jobs.generateDraft, data),
    update: (id: string, data: unknown) =>
      apiClient.put(endpoints.jobs.update(id), data),
  ...
  applications: {
    ...
    create: (data: unknown) =>
      apiClient.post(endpoints.applications.create, data),
    update: (id: string, data: unknown) =>
      apiClient.put(endpoints.applications.update(id), data),
    delete: (id: string) => apiClient.delete(endpoints.applications.delete(id)),
    getByJob: (jobId: string) =>
      apiClient.get(endpoints.applications.byJob(jobId)),
  ...
  candidate: {
    ...
    updateProfile: (data: unknown) =>
      apiClient.patch(endpoints.candidate.me, data),

    experience: {
      add: (data: unknown) =>
        apiClient.post(endpoints.candidate.experience.base, data),
      delete: (id: string) =>
        apiClient.delete(endpoints.candidate.experience.delete(id)),
      update: (id: string, data: unknown) =>
        apiClient.patch(endpoints.candidate.experience.update(id), data),
    },
    education: {
      add: (data: unknown) =>
        apiClient.post(endpoints.candidate.education.base, data),
      delete: (id: string) =>
        apiClient.delete(endpoints.candidate.education.delete(id)),
      update: (id: string, data: unknown) =>
        apiClient.patch(endpoints.candidate.education.update(id), data),
    },
    skills: {
      add: (data: unknown) =>
        apiClient.post(endpoints.candidate.skills.base, data),
      delete: (id: string) =>
        apiClient.delete(endpoints.candidate.skills.delete(id)),
      update: (id: string, data: unknown) =>
        apiClient.patch(endpoints.candidate.skills.update(id), data),
    },
    certifications: {
      add: (data: unknown) =>
        apiClient.post(endpoints.candidate.certifications.base, data),
      delete: (id: string) =>
        apiClient.delete(endpoints.candidate.certifications.delete(id)),
      update: (id: string, data: unknown) =>
        apiClient.patch(endpoints.candidate.certifications.update(id), data),
    },
    socialLinks: {
      add: (data: unknown) =>
        apiClient.post(endpoints.candidate.socialLinks.base, data),
      delete: (id: string) =>
        apiClient.delete(endpoints.candidate.socialLinks.delete(id)),
      update: (id: string, data: unknown) =>
  ...
  resumes: {
    ...
    update: (id: string, data: unknown) =>
      apiClient.put(endpoints.resumes.update(id), data),
    ...
    experiences: {
      ...
      update: (resumeId: string, expId: string, data: unknown) =>
        apiClient.put(
          endpoints.resumes.experiences.update(resumeId, expId),
          data,
        ),
      remove: (resumeId: string, expId: string) =>
    ...
    education: {
      ...
      update: (resumeId: string, eduId: string, data: unknown) =>
        apiClient.put(
          endpoints.resumes.education.update(resumeId, eduId),
          data,
        ),
      remove: (resumeId: string, eduId: string) =>
    ...
    certifications: {
      ...
      update: (resumeId: string, certId: string, data: unknown) =>
        apiClient.put(
          endpoints.resumes.certifications.update(resumeId, certId),
          data,
        ),
      remove: (resumeId: string, certId: string) =>
        apiClient.delete(
          endpoints.resumes.certifications.remove(resumeId, certId),
        ),
    },
    skills: {
      add: (resumeId: string, data: unknown) =>
