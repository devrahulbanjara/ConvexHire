...
from app.models.candidate import (
    CandidateProfile, CandidateWorkExperience, CandidateEducation,
    CandidateCertification, CandidateSocialLink, CandidateSkills
)
...
class CandidateService:
    ...
    @staticmethod
    def _update_item(db: Session, user_id: str, ModelClass, item_id, id_field_name, data_obj):
        stmt = (
            select(ModelClass)
            .join(CandidateProfile)
            .where(ModelClass.__table__.c[id_field_name] == item_id)
    ...
    def add_experience(db: Session, user_id: str, data):
        return CandidateService._add_item(db, user_id, CandidateWorkExperience, data.model_dump(), "candidate_work_experience_id")

    @staticmethod
    def delete_experience(db: Session, user_id: str, item_id: str):
        CandidateService._delete_item(db, user_id, CandidateWorkExperience, item_id, "candidate_work_experience_id")

    @staticmethod
    def update_experience(db: Session, user_id: str, item_id: str, data):
        return CandidateService._update_item(db, user_id, CandidateWorkExperience, item_id, "candidate_work_experience_id", data)

    @staticmethod
    def add_education(db: Session, user_id: str, data):
        return CandidateService._add_item(db, user_id, CandidateEducation, data.model_dump(), "candidate_education_id")

    @staticmethod
    def delete_education(db: Session, user_id: str, item_id: str):
        CandidateService._delete_item(db, user_id, CandidateEducation, item_id, "candidate_education_id")

    @staticmethod
    def update_education(db: Session, user_id: str, item_id: str, data):
        return CandidateService._update_item(db, user_id, CandidateEducation, item_id, "candidate_education_id", data)

    @staticmethod
    def add_skill(db: Session, user_id: str, data):
        return CandidateService._add_item(db, user_id, CandidateSkills, data.model_dump(), "candidate_skill_id")
        
    @staticmethod
    def delete_skill(db: Session, user_id: str, item_id: str):
        CandidateService._delete_item(db, user_id, CandidateSkills, item_id, "candidate_skill_id")

    @staticmethod
    def update_skill(db: Session, user_id: str, item_id: str, data):
        return CandidateService._update_item(db, user_id, CandidateSkills, item_id, "candidate_skill_id", data)

    @staticmethod
    def add_certification(db: Session, user_id: str, data):
        return CandidateService._add_item(db, user_id, CandidateCertification, data.model_dump(), "candidate_certification_id")

    @staticmethod
    def delete_certification(db: Session, user_id: str, item_id: str):
        CandidateService._delete_item(db, user_id, CandidateCertification, item_id, "candidate_certification_id")

    @staticmethod
    def update_certification(db: Session, user_id: str, item_id: str, data):
        return CandidateService._update_item(db, user_id, CandidateCertification, item_id, "candidate_certification_id", data)
